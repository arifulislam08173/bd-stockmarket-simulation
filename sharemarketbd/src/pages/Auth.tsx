  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="container text-center">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <div className="text-left">
              <h1 className="text-2xl font-display font-bold text-primary-foreground">BD Stock Sim</h1>
              <p className="text-sm text-primary-foreground/70">Bangladesh Stock Trading Simulator</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 -mt-8">
        <Card className="w-full max-w-md shadow-lg border-border animate-slide-up">
